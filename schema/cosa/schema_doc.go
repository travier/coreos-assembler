...
// Source hash: 2d6de1c8c40ff66e3f4e2b0e56be6d83151f1abdae3665e0e45ceeed19ea05d8
// DO NOT EDIT
...
var generatedSchemaJSON = `{
 ...
 "properties": {
   ...
   "coreos-assembler.variant": {
     "$id":"#/properties/coreos-assembler.variant",
     "type":"string",
     "title":"Variant used to select the version for the manifest, image and extension YAMLs",
     "default":""
    },
    "fedora-coreos.parent-version": {
